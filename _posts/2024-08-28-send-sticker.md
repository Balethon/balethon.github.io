...
<h1>Client.<strong>send_sticker()</strong></h1>

<p align="left" dir="rtl"><strong>فرستادن پیام دارای استیکر</strong></p>
...
```python
await bot.send_sticker(1234567890, "sticker.png", "Hello")
```